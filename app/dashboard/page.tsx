...
export default function Biblioteca() {
  ...
  return (
    <main className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen pb-20 font-sans">
      
      {/* HEADER */}
      <header className="w-full mb-10 pt-8 flex flex-col items-center">
        <div className="flex flex-row items-center justify-center gap-4 bg-white p-2 px-4 rounded-2xl shadow-sm border border-gray-100 w-full max-w-2xl">
          <div className="flex items-center gap-2 border-r border-gray-100 pr-4">
            <input 
              type="text" placeholder="El teu nom..." 
              className="text-xs p-2 outline-none w-24 md:w-32 bg-transparent"
        ...
        <div className="flex items-center gap-2 bg-white p-2 rounded-3xl shadow-xl border border-gray-100">
          <div className="flex-grow relative flex items-center pl-4">
            ...
            <input
              ...
              className="w-full pl-4 pr-4 py-3 outline-none bg-transparent text-lg"
